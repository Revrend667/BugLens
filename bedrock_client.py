...
class BedrockClient:
    ...
    def _analyze_chunk(self, chunk: str, idx: int, total: int) -> str:
        ...
        prompt = (
            ...
            "- Provide actionable, technical improvements.\n"
            "- Use a numbered Markdown list.\n\n"
            "### 3. QA Learnings / Improvements / Action Items\n"
            "- Provide concrete QA learnings and Action items.\n"
            "- Use a numbered Markdown list.\n\n"
    ...
    def _merge_summaries(self, summaries: List[str]) -> str:
        ...
        combined_prompt = (
            ...
            "### 2. Developer Learnings / Improvements / Action Items\n"
            "- Deduplicated list of actionable developer improvements and/or Action items.\n"
            "- Remove repeated or rephrased items.\n"
            "- Use a numbered Markdown list.\n\n"
            "### 3. QA Learnings / Improvements / Action Items\n"
            "- Deduplicated list of QA learnings and/or Action items.\n"
            "- Remove repeated or rephrased items.\n"
            "- Use a numbered Markdown list.\n\n"
            "⚠️ Important:\n"
